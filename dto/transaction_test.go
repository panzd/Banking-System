...
func Test_shoule_return_error_when_transaction_type_is_not_deposit_or_withdrawl(t *testing.T) {
	//Arrange
	...
	//Assert
	if appError.Message != "Transaction type can only be deposit or withdrawl" {
...
func Test_shoule_return_error_when_amount_is_less_than_zero(t *testing.T) {
